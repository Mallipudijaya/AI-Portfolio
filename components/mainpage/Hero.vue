...
const images = [
  ...
  },
  {
    ...
    key: 'UX/UI design',
    coords: 'left-80 bottom-80',
  },
  {
    src: '/pixels/nuxt.png',
    key: 'Full-stack website development',
    coords: 'right-40 top-80',
  },
  {
    src: '/pixels/i18n.png',
    key: 'i18n and l10n.',
    coords: 'right-80 bottom-90',
  },
]
</script>
...
<template>
  <section
    class="relative container mx-auto flex flex-col items-center justify-center w-full gap-4 sm:gap-10 pt-6 pb-16 font-sans md:pb-24 md:pt-16 lg:pb-42 lg:pt-30 isolate gradient px-6 2xl:px-0"
    aria-label="My abilities"
  >
    <uiBadge>✨ Looking for a job</uiBadge>
    <div class="max-w-3xl flex flex-col gap-4 sm:gap-8 mb-8">
      <h1
    ...
    <div class="grid grid-cols-2 sm:grid-cols-4 gap-6 mt-12 2xl:space-x-0 2xl:mt-0">
      <nuxt-img
